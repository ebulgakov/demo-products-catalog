export default async function Auth() {
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="shadow-card rounded-5xl bg-white p-1.5 [box-shadow:0px_24px_32px_0px_rgba(0,0,0,0.04)]">
        <div className="card-wrapper">
          <div className="card-inner flex min-w-[527px] flex-col items-center gap-8 px-12 py-12">
            ...
            <div className="flex w-full flex-col items-center gap-3">
              <h1 className="title-text text-dark text-center text-[40px] leading-[1.1em] font-semibold tracking-[-0.6px]">
                Добро пожаловать!
              </h1>
              <p className="w-full text-center text-[18px] leading-[1.5em] font-medium text-[#E0E0E0] [text-shadow:inset_0px_4px_4px_0px_rgba(0,0,0,0.17)]">
            ...
            <div className="flex w-[399px] flex-col gap-5">
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-dark text-[18px] leading-[1.5em] font-medium tracking-[-0.27px]">
                    Логин
                  </label>
                  <div className="form-input flex h-[54px] w-[399px] flex-row items-center gap-3.5 rounded-xl border-[1.5px] border-[#EDEDED] bg-white px-4">
                    ...
                    <input
                      type="text"
                      value="test"
                      className="text-dark w-[293px] flex-1 bg-transparent text-[18px] leading-[1.5em] font-medium tracking-[-0.27px] outline-none"
                    />
                    <svg
                      width="14"
                      height="16"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex h-[54px] w-[399px] flex-row items-center justify-center gap-3.5 rounded-xl border-[1.5px] border-[#EDEDED] bg-white px-4">
                    ...
                    <input
                      type="password"
                      value="password123"
                      className="text-dark flex-1 bg-transparent text-[18px] leading-[1.5em] font-medium tracking-[-0.27px] outline-none"
                    />
                    <svg
                      width="24"
                      height="24"
              ...
              <div className="flex flex-row items-center gap-2.5">
                ...
                <span className="text-muted text-[16px] leading-[1.5em] font-medium">
                  Запомнить данные
                </span>
              </div>
              ...
              <div className="flex w-full flex-col gap-4">
                <button className="btn-primary flex w-full items-center justify-center rounded-xl py-4">
                  <span className="text-[18px] leading-[1.2em] font-semibold tracking-[-0.18px] text-white">
                    Войти
                  </span>
                </button>
                ...
                <div className="flex w-full flex-row items-center gap-2.5">
                  ...
                  <span className="or-text shrink-0 text-[16px] leading-[1.5em] font-medium text-[#EBEBEB]">
                    или
                  </span>
                  <svg
                    className="flex-1"
